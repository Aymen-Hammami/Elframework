<?php
namespace Elframework\Manager;
//this is our global manager,every entity manager should extend from this global manager
require dirname(__DIR__, 2) . '/config/database.php';
#doctrine and eloquent are overrated !
